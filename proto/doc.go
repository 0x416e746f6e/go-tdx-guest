...
//go:generate protoc -I$PROTOC_INSTALL_DIR/include -I=. --go_out=. --go_opt=module=github.com/0x416e746f6e/go-tdx-guest/proto tdx.proto
//go:generate protoc -I$PROTOC_INSTALL_DIR/include -I=. --go_out=. --go_opt=module=github.com/0x416e746f6e/go-tdx-guest/proto checkconfig.proto
